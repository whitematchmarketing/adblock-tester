...
<h3 class="final-score" data-color={color}>
  <div class="final-score-text">
    ...
    <span class="final-score-pre-value-text"
      >{t("score.points", $score, false)} {t("score.outOf")} 100</span
    >
  </div>
...
<style>
  ...
  .night-mode-on .final-score {
    text-shadow: 0 0 4px rgba(255, 255, 255, 0.15);
  }
  .final-score[data-color="red"] {
    background-color: var(--color-red);
  }
  .final-score[data-color="pumpkin"] {
    background-color: var(--color-pumpkin);
  }
  .final-score[data-color="orange"] {
    background-color: var(--color-orange);
  }
  .final-score[data-color="green"] {
    background-color: var(--color-green);
  }
