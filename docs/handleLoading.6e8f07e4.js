...
},{"./variables":"scripts/variables.ts"}],"scripts/handleLoading.ts":[function(require,module,exports) {
"use strict";
...
var handleFactory = function handleFactory(result) {
  return function ($el) {
    var $input = $el.closest("li").querySelector("[" + variables_1.CHECK_LOADING_ATTRIBUTE + "]");

    if (!$input) {
      console.warn("No " + variables_1.CHECK_LOADING_ATTRIBUTE + " in parent", $el);
      return;
    }

    helpers_1.extendAttribute($input, variables_1.CHECK_LOADING_ATTRIBUTE, result);
  };
};

window.isArray = Array.isArray;
window.flashSupported = helpers_1.flashSupported;
window.handleLoad = handleFactory(variables_1.STATUS_LOADING_SUCCESS);
window.handleError = handleFactory(variables_1.STATUS_LOADING_FAILURE);
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/handleLoading.ts"], null)
//# sourceMappingURL=/handleLoading.6e8f07e4.js.map